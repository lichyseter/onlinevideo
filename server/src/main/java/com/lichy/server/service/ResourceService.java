...
import com.lichy.server.domain.Resource;
import com.lichy.server.domain.ResourceExample;
import com.lichy.server.dto.PageDto;
import com.lichy.server.dto.ResourceDto;
import com.lichy.server.mapper.ResourceMapper;
...
public class ResourceService {
    ...
    public void saveJson(String json) {
        ...
        List<ResourceDto> jsonList = null;
        try {
            jsonList = objectMapper.readerForArrayOf(ResourceDto.class).readValue(json);
