package com.lichy.course.controller.admin;


import com.lichy.server.dto.FileDto;
import com.lichy.server.dto.ResponseDto;
import com.lichy.server.enums.FileUseEnum;
import com.lichy.server.service.FileService;
import com.lichy.server.util.Base64ToMultipartFile;
...
//        }
    ...
    public ResponseDto getAuth(@PathVariable String vod) {
        LOG.info("获取播放授权开始: ");
        ResponseDto responseDto = new ResponseDto();
