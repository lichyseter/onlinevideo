package com.lichy.business.controller.web;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.lichy.server.dto.LoginMemberDto;
import com.lichy.server.dto.MemberDto;
import com.lichy.server.dto.ResponseDto;
import com.lichy.server.dto.SmsDto;
import com.lichy.server.enums.SmsUseEnum;
import com.lichy.server.exception.BusinessException;
import com.lichy.server.service.MemberService;
import com.lichy.server.service.SmsService;
import com.lichy.server.util.UuidUtil;
import com.lichy.server.util.ValidatorUtil;
...
public class MemberController {
     ...
     */
    @PostMapping("/login")
    public ResponseDto login(@RequestBody MemberDto memberDto) throws JsonProcessingException {
        LOG.info("用户登录开始");
        memberDto.setPassword(DigestUtils.md5DigestAsHex(memberDto.getPassword().getBytes()));
        ResponseDto responseDto = new ResponseDto();
        ...
        redisTemplate.opsForValue().set(token, new ObjectMapper().writeValueAsString(loginMemberDto), 3600, TimeUnit.SECONDS);
